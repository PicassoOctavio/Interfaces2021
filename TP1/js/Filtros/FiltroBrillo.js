class FiltroBrillo{
    ...
    aplicar( canvas ){
        ...
        // BRILLO: agarrar un pixel y convertirlo de rgb a hsb, aumentarle la B, y convertirlo de nuevo a rgb
        ...
        for (let i = 0; i < pixels.length; i += 4) {
            ...
            // brillo
            objHsv.v += 0.2; //<-- valor a cambiar con un posible slider
            
            // saturacion
            //objHsv.s += 1; //<-- valor a cambiar con un posible slider
